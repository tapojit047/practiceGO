...
func (m *AzureManagedMachinePool) validateName() error {
	...
	if err := checkNameLengthValidity(m.Spec.OSType, name, fieldNameMessage); err != nil {
		return err
	}
	return checkNamePatternValidity(name, fieldNameMessage)
}

func checkNameLengthValidity(osType *string, name *string, fieldNameMessage string) error {
...
func checkNamePatternValidity(name *string, fieldNameMessage string) error {
